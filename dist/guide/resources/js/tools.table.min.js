!(function (e, t) {
  ...
  (T.fn = T.prototype =
    ...
    T.extend({
      ...
      camelCase: function (e) {
        return e.replace(I, 'ms-').replace(X, O);
      },
  ...
  var e = (function ($) {
      ...
      var e,
        ...
        se = /[+~]/,
        le = /'|\\/g,
        f = new RegExp('\\\\([\\da-f]{1,6}' + a + '?|(' + a + ')|.)', 'ig');
      try {
        N.apply((n = J.call(y.childNodes)), y.childNodes),
          ...
          if (h.qsa && !b[e + ' '] && (!m || !m.test(e))) {
            if (1 !== f) (p = t), (d = e);
              ...
              for (
                ...
                c[o] = l + ' ' + q(c[o]);
              (d = c.join(',')), (p = (se.test(e) && pe(t.parentNode)) || t);
            }
            if (d)
              try {
        ...
        function (e) {
          ...
          return (
            e !== C &&
              ...
              (h.getElementsByClassName = c.test(C.getElementsByClassName)),
              (h.getById = H(function (e) {
                return (
              ...
              (r = []),
              (m = []),
              (h.qsa = c.test(C.querySelectorAll)) &&
                (H(function (e) {
              ...
              (h.matchesSelector = c.test(
                ...
                H(function (e) {
                  (h.disconnectedMatch = i.call(e, 'div')),
                    i.call(e, "[s!='']:x"),
                    r.push('!=', Q);
                }),
        ...
        return (
          ...
          j(function (e, t, n, r) {
            var i,
              ...
              d = !f || (!e && h) ? c : M(c, s, f, n, r),
              p = g ? (v || (e ? f : u || m) ? [] : t) : d;
            if ((g && g(d, p, n, r), m))
              for (i = M(p, l), m(i, [], n, r), o = i.length; o--; )
                (a = i[o]) && (p[l[o]] = !(d[l[o]] = a));
            if (e) {
              if (v || f) {
                if (v) {
            ...
            } else (p = M(p === t ? p.splice(u, p.length) : p)), v ? v(null, t, p, r) : N.apply(t, p);
          })
        );
      }
      function ve(m, v) {
        function e(e, t, n, r, i) {
          ...
          if (((l += u), y && u !== l)) {
            ...
            if (e) {
              if (0 < l) for (; u--; ) c[u] || d[u] || (d[u] = U.call(r));
              d = M(d);
            }
            N.apply(r, d),
              i && !e && 0 < d.length && 1 < l + v.length && L.uniqueSort(r);
          }
          return i && ((k = h), (w = p)), c;
        }
        var y = 0 < v.length,
      ...
      return (
        ...
        (g = L.tokenize =
          function (e, t) {
            ...
            return t ? a.length : a ? L.error(e) : z(e, s).slice(0);
          }),
        (F = L.compile =
          function (e, t) {
            var n,
              ...
              for (n = (t = t || g(e)).length; n--; )
                ((o = (function e(t) {
                  for (
                    ...
                    if ((n = x.relative[t[l].type])) d = [he(ge(d), n)];
                    else {
                      if (
          ...
          function (e, t, n, r) {
            ...
            if (((n = n || []), 1 === c.length)) {
              if (
                ...
                if (!(t = (x.find.ID(a.matches[0].replace(f, d), t) || [])[0]))
                  return n;
              ...
              for (
                ...
                if (
                  (l = x.find[s]) &&
                  (r = l(
                    a.matches[0].replace(f, d),
                    (se.test(o[0].type) && pe(t.parentNode)) || t
                  ))
                ) {
            ...
            return (
              (u || F(e, c))(
                ...
                !E,
                n,
                !t || (se.test(e) && pe(t.parentNode)) || t
              ),
              n
            );
          }),
        (h.sortStable = S.split('').sort(I).join('') === S),
        (h.detectDuplicates = !!u),
        T(),
        (h.sortDetached = H(function (e) {
  ...
  (T.filter = function (e, t, n) {
    ...
    T.fn.extend({
      ...
      is: function (e) {
        return !!Q(this, 'string' == typeof e && J.test(e) ? T(e) : e || [], !1)
          .length;
      },
    });
  var K,
    ...
    closest: function (e, t) {
      for (
        var n,
          ...
          i = this.length,
          o = [],
          a = J.test(e) || 'string' != typeof e ? T(e, t || this.context) : 0;
        r < i;
        r++
      )
        ...
        T.fn[r] = function (e, t) {
          ...
          return (
            (t = 'Until' !== r.slice(-5) ? e : t) &&
              ...
              (n = T.filter(t, n)),
            1 < this.length &&
              (te[r] || (n = T.uniqueSort(n)), ee.test(r)) &&
              (n = n.reverse()),
            this.pushStack(n)
          );
        };
  ...
  function oe() {
    h.addEventListener
      ? (h.removeEventListener('DOMContentLoaded', t),
        w.removeEventListener('load', t))
      : (h.detachEvent('onreadystatechange', t), w.detachEvent('onload', t));
  }
  function t() {
    (!h.addEventListener &&
      'load' !== w.event.type &&
    ...
    var o,
      ...
      d = {
        ...
        fireWith: function (e, t) {
          return (
            s ||
              ((t = [e, (t = t || []).slice ? t.slice() : t]), u.push(t), o) ||
              i(),
            this
          );
        },
  ...
  (T.ready.promise = function (e) {
    if (!re)
      if (((re = T.Deferred()), 'complete' === h.readyState))
    ...
    T(function () {
      ...
      n &&
        ...
        void 0 !== e.style.zoom &&
          ...
          (m.inlineBlockNeedsLayout = e = 3 === e.offsetWidth),
          e) &&
          (n.style.zoom = 1),
        n.removeChild(t));
    });
    ...
    if (v(e)) {
      ...
      if (
        ...
        return (
          ...
          void 0 !== n && (e[T.camelCase(t)] = n),
          'string' == typeof t
            ? null == (i = e[t]) && (i = e[T.camelCase(t)])
            : (i = e),
          i
        );
    }
  ...
  function de(e, t, n) {
    if (v(e)) {
      ...
      if (a[s]) {
        ...
        (n || (delete a[s].data, ue(a[s]))) &&
          (o
            ? T.cleanData([e], !0)
            : m.deleteExpando || a != a.window
            ? delete a[s]
            : (a[s] = void 0));
      }
    }
  ...
  T.extend({
    ...
    hasData: function (e) {
      return (
        !!(e = e.nodeType ? T.cache[e[T.expando]] : e[T.expando]) && !ue(e)
      );
    },
    data: function (e, t, n) {
      return ce(e, t, n);
    ...
    T.fn.extend({
      data: function (e, t) {
        ...
        if (
          this.length &&
          ((i = T.data(o)), 1 === o.nodeType) &&
          !T._data(o, 'parsedAttrs')
        ) {
          for (n = a.length; n--; )
            a[n] &&
              0 === (r = a[n].name).indexOf('data-') &&
              le(o, (r = T.camelCase(r.slice(5))), i[r]);
  ...
  function he(e, t, n, r) {
    var i,
      ...
      c = (T.cssNumber[t] || ('px' !== u && +l)) && fe.exec(T.css(e, t));
    if (c && c[3] !== u)
      for (
        u = u || c[3], n = n || [], c = +l || 1;
        T.style(e, t, (c /= o = o || '.5') + u),
          o !== (o = s() / l) && 1 !== o && --a;
  ...
  (M = h.createElement('div')),
    ...
    (H = h.createElement('input')),
    (M.innerHTML =
      "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
    (m.leadingWhitespace = 3 === M.firstChild.nodeType),
    (m.tbody = !M.getElementsByTagName('tbody').length),
    (m.htmlSerialize = !!M.getElementsByTagName('link').length),
    (m.html5Clone =
      '<:nav></:nav>' !== h.createElement('nav').cloneNode(!0).outerHTML),
    (H.type = 'checkbox'),
    (H.checked = !0),
    k.appendChild(H),
    (m.appendChecked = H.checked),
    (M.innerHTML = '<textarea>x</textarea>'),
    (m.noCloneChecked = !!M.cloneNode(!0).lastChild.defaultValue),
    k.appendChild(M),
    (H = h.createElement('input')).setAttribute('type', 'radio'),
    H.setAttribute('checked', 'checked'),
    H.setAttribute('name', 't'),
    M.appendChild(H),
    (m.checkClone = M.cloneNode(!0).cloneNode(!0).lastChild.checked),
    (m.noCloneEvent = !!M.addEventListener),
    (M[T.expando] = 1),
    (m.attributes = !M.getAttribute(T.expando));
  var y = {
  ...
  function b(e, t) {
    ...
    if (!o)
      for (o = [], n = e.childNodes || e; null != (r = n[i]); i++)
        !t || T.nodeName(r, t) ? o.push(r) : T.merge(o, b(r, t));
  ...
  function Se(e, t, n, r, i) {
    for (
      var o, a, s, l, u, c, d, p = e.length, f = xe(t), h = [], g = 0;
      g < p;
      g++
    )
      if ((a = e[g]) || 0 === a)
        if ('object' === T.type(a)) T.merge(h, a.nodeType ? [a] : a);
          ...
          for (
            l = l || f.appendChild(t.createElement('div')),
              u = (me.exec(a) || ['', ''])[1].toLowerCase(),
              d = y[u] || y._default,
              l.innerHTML = d[1] + T.htmlPrefilter(a) + d[2],
              o = d[0];
            o--;
          ...
          if (
            ...
            for (
              ...
              T.nodeName((c = a.childNodes[o]), 'tbody') &&
                !c.childNodes.length &&
                a.removeChild(c);
          for (T.merge(h, l.childNodes), l.textContent = ''; l.firstChild; )
            l.removeChild(l.firstChild);
          l = f.lastChild;
        } else h.push(t.createTextNode(a));
    for (
      l && f.removeChild(l),
        m.appendChecked || T.grep(b(h, 'input'), Ee),
        g = 0;
      (a = h[g++]);
  ...
  var ke,
    Ne,
    De = h.createElement('div');
  for (ke in { submit: !0, change: !0, focusin: !0 })
    (Ne = 'on' + ke),
      (m[ke] = Ne in w) ||
        (De.setAttribute(Ne, 't'), (m[ke] = !1 === De.attributes[Ne].expando));
  ...
  (T.event = {
    ...
    trigger: function (e, t, n, r) {
      ...
      if (
        3 !== n.nodeType &&
        8 !== n.nodeType &&
        !He.test(d + T.event.triggered) &&
        (-1 < d.indexOf('.') && ((d = (p = d.split('.')).shift()), p.sort()),
        (o = d.indexOf(':') < 0 && 'on' + d),
        ((e = e[T.expando]
          ? e
          : new T.Event(d, 'object' == typeof e && e)).isTrigger = r ? 2 : 3),
        (e.namespace = p.join('.')),
        ...
        if (!r && !s.noBubble && !T.isWindow(n)) {
          for (
            a = s.delegateType || d, He.test(a + d) || (f = f.parentNode);
            f;
            f = f.parentNode
          )
            c.push(f), (l = f);
          l === (n.ownerDocument || h) &&
            c.push(l.defaultView || l.parentWindow || w);
        }
        for (u = 0; (f = c[u++]) && !e.isPropagationStopped(); )
          (e.type = 1 < u ? a : s.bindType || d),
            ...
            (i = o && f[o]) &&
              i.apply &&
              v(f) &&
              ((e.result = i.apply(f, t)), !1 === e.result) &&
              e.preventDefault();
        if (
          ((e.type = d),
          !r &&
          ...
          (l = n[o]) && (n[o] = null), (T.event.triggered = d);
          try {
            n[d]();
          } catch (e) {}
    ...
    fix: function (e) {
      ...
      for (
        a ||
          (this.fixHooks[i] = a =
            je.test(i) ? this.mouseHooks : Le.test(i) ? this.keyHooks : {}),
    ...
    m.change ||
      (T.event.special.change = {
        ...
        teardown: function () {
          return T.event.remove(this, '._change'), !Ae.test(this.nodeName);
        },
      }),
    m.focusin ||
  ...
  var Oe = / jQuery\d+="(?:null|\d+)"/g,
    ...
    Be = /^true\/(.*)/,
    ze = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
    Ie = xe(h).appendChild(h.createElement('div'));
  function Xe(e, t) {
  ...
  function x(n, r, i, o) {
    ...
    var e,
      ...
      f = r[0],
      h = T.isFunction(f);
    if (h || (1 < d && 'string' == typeof f && !m.checkClone && Pe.test(f)))
      return n.each(function (e) {
        var t = n.eq(e);
        h && (r[0] = f.call(this, e, t.html())), x(t, r, i, o);
      });
    if (
      d &&
      ((e = (u = Se(r, n[0].ownerDocument, !1, n, o)).firstChild),
      1 === u.childNodes.length && (u = e),
      e || o)
    ) {
      for (a = (s = T.map(b(u, 'script'), Ue)).length; c < d; c++)
        (t = u),
          c !== p &&
            ((t = T.clone(t, !0, !0)), a) &&
            T.merge(s, b(t, 'script')),
          i.call(n[c], t, c);
      if (a)
        for (l = s[s.length - 1].ownerDocument, T.map(s, Ve), c = 0; c < a; c++)
          (t = s[c]),
            ve.test(t.type || '') &&
  ...
  function Ye(e, t, n) {
    for (var r, i = t ? T.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || T.cleanData(b(r)),
        r.parentNode &&
          (n && T.contains(r.ownerDocument, r) && we(b(r, 'script')),
  ...
  T.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        (m.html5Clone || T.isXMLDoc(e) || !Re.test('<' + e.nodeName + '>')
          ? (o = e.cloneNode(!0))
          : ((Ie.innerHTML = e.outerHTML), Ie.removeChild((o = Ie.firstChild))),
        !(
          ...
          if (r[a]) {
            ...
            if (1 === f.nodeType) {
              if (
                ...
                !m.noCloneEvent && f[T.expando])
              ) {
                for (u in (c = T._data(f)).events)
                  T.removeEvent(f, u, c.handle);
                f.removeAttribute(T.expando);
              }
              'script' === l && f.text !== p.text
                ? ((Ue(f).text = p.text), Ve(f))
                : 'object' === l
      ...
      return (
        0 < (r = b(o, 'script')).length && we(r, !d && b(e, 'script')),
        (r = s = i = null),
        o
      );
    },
        ...
        return p(
          ...
          function (e) {
            ...
            if (
              'string' == typeof e &&
              !We.test(e) &&
              (m.htmlSerialize || !Re.test(e)) &&
              (m.leadingWhitespace || !ye.test(e)) &&
              !y[(me.exec(e) || ['', ''])[1].toLowerCase()]
            ) {
              e = T.htmlPrefilter(e);
              try {
                for (; n < r; n++)
  ...
  function a() {
    ...
    t.appendChild(at),
      ...
      w.getComputedStyle &&
        ...
        ((e = o.appendChild(h.createElement('div'))).style.cssText =
          o.style.cssText =
            '-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0'),
        (e.style.marginRight = e.style.width = '0'),
        (o.style.width = '1px'),
        (it = !parseFloat((w.getComputedStyle(e) || {}).marginRight)),
        o.removeChild(e)),
      (o.style.display = 'none'),
      (rt = 0 === o.getClientRects().length) &&
        ((o.style.display = ''),
        (o.innerHTML = '<table><tr><td></td><td>t</td></tr></table>'),
        ((e = o.getElementsByTagName('td'))[0].style.cssText =
          'margin:0;border:0;padding:0;display:none'),
        (rt = 0 === e[0].offsetHeight)) &&
        ((e[0].style.display = ''),
        (e[1].style.display = 'none'),
        (rt = 0 === e[0].offsetHeight)),
      t.removeChild(at);
  }
  (at = h.createElement('div')),
    (o = h.createElement('div')).style &&
      ...
      ((at = h.createElement('div')).style.cssText =
        'border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute'),
      (o.innerHTML = ''),
      at.appendChild(o),
      (m.boxSizing =
        '' === o.style.boxSizing ||
        '' === o.style.MozBoxSizing ||
        '' === o.style.WebkitBoxSizing),
      T.extend(m, {
  ...
  w.getComputedStyle
    ? ((u = function (e) {
        ...
        return (t = t.opener ? t : w).getComputedStyle(e);
      }),
      (f = function (e, t, n) {
        var r,
          i = e.style,
          o = (n = n || u(e)) ? n.getPropertyValue(t) || n[t] : void 0;
        return (
          n &&
            ('' !== o || T.contains(e.ownerDocument, e) || (o = T.style(e, t)),
            !m.pixelMarginRight()) &&
            lt.test(o) &&
            st.test(t) &&
            ((e = i.width),
      ...
      (r = e[a]).style &&
        ...
        t
          ? (o[a] || 'none' !== n || (r.style.display = ''),
            '' === r.style.display &&
              pe(r) &&
              (o[a] = T._data(r, 'olddisplay', Ze(r.nodeName))))
          : ((i = pe(r)),
            ((n && 'none' !== n) || !i) &&
  ...
  function Ct(e, t, n, r, i) {
    for (
      ...
      'margin' === n && (a += T.css(e, n + s[o], !0, i)),
        r
          ? ('content' === n && (a -= T.css(e, 'padding' + s[o], !0, i)),
            'margin' !== n && (a -= T.css(e, 'border' + s[o] + 'Width', !0, i)))
          : ((a += T.css(e, 'padding' + s[o], !0, i)),
            'padding' !== n &&
              (a += T.css(e, 'border' + s[o] + 'Width', !0, i)));
    return a;
  }
  function Et(e, t, n) {
    var r = !0,
    ...
    if (
      (i =
        h.msFullscreenElement && w.top !== w && e.getClientRects().length
          ? Math.round(100 * e.getBoundingClientRect()[t])
          : i) <= 0 ||
      null == i
    ) {
      if ((((i = f(e, t, o)) < 0 || null == i) && (i = e.style[t]), lt.test(i)))
        return i;
  ...
  T.extend({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          l = e.style;
        if (
          ((t = T.cssProps[s] || (T.cssProps[s] = xt(s) || s)),
    ...
    css: function (e, t, n, r) {
      var i,
        o = T.camelCase(t);
      return (
        (t = T.cssProps[o] || (T.cssProps[o] = xt(o) || o)),
        'normal' ===
          (i =
            void 0 ===
            (i =
    ...
    T.each(['height', 'width'], function (e, i) {
      T.cssHooks[i] = {
        get: function (e, t, n) {
          return t
            ? ht.test(T.css(e, 'display')) && 0 === e.offsetWidth
              ? et(e, mt, function () {
                  return Et(e, i, n);
                })
              : Et(e, i, n)
          ...
          return Tt(
            ...
            n
              ? Ct(
                  ...
                  i,
                  n,
                  m.boxSizing && 'border-box' === T.css(e, 'boxSizing', !1, r),
                  r
                )
              : 0
          );
      ...
      (T.cssHooks.opacity = {
        ...
        set: function (e, t) {
          ...
          (((n.zoom = 1) <= t || '' === t) &&
            ...
            (n.filter = pt.test(i) ? i.replace(pt, r) : i + ' ' + r);
        },
      }),
    (T.cssHooks.marginRight = dt(m.reliableMarginRight, function (e, t) {
      return t
        ? et(e, { display: 'inline-block' }, f, [e, 'marginRight'])
        : void 0;
    })),
    (T.cssHooks.marginLeft = dt(m.reliableMarginLeft, function (e, t) {
      return t
  ...
  function Lt(e, t, n) {
    for (
      var r,
        i = (N.tweeners[t] || []).concat(N.tweeners['*']),
        o = 0,
        a = i.length;
      o < a;
      o++
  ...
  function N(i, e, t) {
    ...
    for (r in m)
      if (
        ...
        (s = v[a]),
        (l = m[r]),
        T.isArray(l) && ((s = l[1]), (l = m[r] = l[0])),
        r !== a && ((m[a] = l), delete m[r]),
        (u = T.cssHooks[a]),
        u && 'expand' in u)
      )
        for (r in ((l = u.expand(l)), delete m[a], l))
          r in m || ((m[r] = l[r]), (v[r] = s));
      else v[a] = s;
    for (; c < d; c++)
      if ((n = N.prefilters[c].call(h, i, g, h.opts)))
        return (
          T.isFunction(n.stop) &&
            (T._queueHooks(h.elem, h.opts.queue).stop = T.proxy(n.stop, n)),
          n
        );
    return (
      T.map(g, Lt, h),
      T.isFunction(h.opts.start) && h.opts.start.call(i, h),
      T.fx.timer(T.extend(f, { elem: i, anim: h, queue: h.opts.queue })),
      h
  ...
  (T.Animation = T.extend(N, {
    tweeners: {
      '*': [
        function (e, t) {
          ...
          return he(n.elem, e, fe.exec(t), n), n;
        },
      ],
    },
    tweener: function (e, t) {
      for (
        var n,
          r = 0,
          i = (e = T.isFunction(e) ? ((t = e), ['*']) : e.match(C)).length;
        r < i;
        r++
      )
        (n = e[r]),
        ...
        1 === t.nodeType &&
          ...
          'inline' ===
            ('none' === (u = T.css(t, 'display'))
              ? T._data(t, 'olddisplay') || Ze(t.nodeName)
              : u)) &&
          'none' === T.css(t, 'float') &&
          (m.inlineBlockNeedsLayout && 'inline' !== Ze(t.nodeName)
            ? (p.zoom = 1)
      ...
      stop: function (i, e, o) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (t in r) r[t] && r[t].stop && Nt.test(t) && a(r[t]);
            for (t = n.length; t--; )
              n[t].elem !== this ||
                (null != i && n[t].queue !== i) ||
    ...
    (T.fx.tick = function () {
      var e,
        t = T.timers,
        n = 0;
      for (S = T.now(); n < t.length; n++)
        (e = t[n])() || t[n] !== e || t.splice(n--, 1);
      t.length || T.fx.stop(), (S = void 0);
    }),
    ...
    (T.fx.interval = 13),
    (T.fx.start = function () {
      St = St || w.setInterval(T.fx.tick, T.fx.interval);
    }),
    (T.fx.stop = function () {
      w.clearInterval(St), (St = null);
    }),
    ...
    (k = h.createElement('input')),
    (H = h.createElement('div')),
    (M = h.createElement('select')),
    (e = M.appendChild(h.createElement('option'))),
    (H = h.createElement('div')).setAttribute('className', 't'),
    (H.innerHTML =
      "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>"),
    (q = H.getElementsByTagName('a')[0]),
    k.setAttribute('type', 'checkbox'),
    H.appendChild(k),
    ((q = H.getElementsByTagName('a')[0]).style.cssText = 'top:1px'),
    (m.getSetAttribute = 't' !== H.className),
    (m.style = /top/.test(q.getAttribute('style'))),
    (m.hrefNormalized = '/a' === q.getAttribute('href')),
    (m.checkOn = !!k.value),
    (m.optSelected = e.selected),
    (m.enctype = !!h.createElement('form').enctype),
    (M.disabled = !0),
    (m.optDisabled = !e.disabled),
    (k = h.createElement('input')).setAttribute('value', ''),
    (m.input = '' === k.getAttribute('value')),
    (k.value = 't'),
    k.setAttribute('type', 'radio'),
    (m.radioValue = 't' === k.value);
  var jt = /\r/g;
  T.fn.extend({
    val: function (t) {
      var n,
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              ...
              if (((r = i[a]), 0 <= T.inArray(T.valHooks.option.get(r), o)))
                try {
                  r.selected = n = !0;
                } catch (e) {
                  r.scrollHeight;
  ...
  var D,
    ...
    Mt =
      (T.fn.extend({
        attr: function (e, t) {
          return p(this, T.attr, e, t, 1 < arguments.length);
        },
        ...
        attr: function (e, t, n) {
          ...
          if (3 !== o && 8 !== o && 2 !== o)
            return void 0 === e.getAttribute
              ...
              : ((1 === o && T.isXMLDoc(e)) ||
                  ((t = t.toLowerCase()),
                  (i = T.attrHooks[t] || (T.expr.match.bool.test(t) ? Ht : D))),
                void 0 !== n
                  ? null === n
        ...
        set: function (e, t, n) {
          return (
            !1 === t
              ? T.removeAttr(e, n)
              : (qt && L) || !_t.test(n)
              ? e.setAttribute((!L && T.propFix[n]) || n, n)
    ...
    Ot =
      (T.fn.extend({
        prop: function (e, t) {
          return p(this, T.prop, e, t, 1 < arguments.length);
        },
        ...
        propHooks: {
          tabIndex: {
            get: function (e) {
              ...
              return t
                ? parseInt(t, 10)
                : Mt.test(e.nodeName) || ($t.test(e.nodeName) && e.href)
                ? 0
                : -1;
            },
          },
  ...
  T.fn.extend({
    ...
    toggleClass: function (i, t) {
      ...
      return 'boolean' == typeof t && 'string' == o
        ...
        : T.isFunction(i)
        ? this.each(function (e) {
            T(this).toggleClass(i.call(this, e, j(this), t), t);
          })
        : this.each(function () {
            var e, t, n, r;
            if ('string' == o)
              for (t = 0, n = T(this), r = i.match(C) || []; (e = r[t++]); )
                n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
            else
              (void 0 !== i && 'boolean' != o) ||
                ((e = j(this)) && T._data(this, '__className__', e),
                T.attr(
                  this,
                  'class',
  ...
  T.extend({
    ...
    ajax: function (e, t) {
      ...
      if (
        ...
        f.hasContent ||
          (f.data &&
            ((l = f.url += (Ft.test(l) ? '&' : '?') + f.data), delete f.data),
          !1 === f.cache &&
            (f.url = Bt.test(l)
              ? l.replace(Bt, '$1_=' + Rt++)
              : l + (Ft.test(l) ? '&' : '?') + '_=' + Rt++)),
        f.ifModified &&
          (T.lastModified[l] &&
            x.setRequestHeader('If-Modified-Since', T.lastModified[l]),
          T.etag[l]) &&
        ...
        if (f.beforeSend && (!1 === f.beforeSend.call(h, x, f) || 2 === b))
          return x.abort();
        for (n in ((a = 'abort'), { success: 1, error: 1, complete: 1 }))
          x[n](f[n]);
        if ((p = Kt(Jt, f, t, x))) {
          if (((x.readyState = 1), d && g.trigger('ajaxSend', [x, f]), 2 === b))
            return x;
          f.async &&
            0 < f.timeout &&
      ...
      function s(e, t, n, r) {
        ...
        2 !== b &&
          ...
          (x.status = e),
          (x.statusText = (t || s) + ''),
          r ? m.resolveWith(h, [i, s, x]) : m.rejectWith(h, [x, s, o]),
          x.statusCode(y),
          (y = void 0),
          d && g.trigger(r ? 'ajaxSuccess' : 'ajaxError', [x, f, r ? i : o]),
          v.fireWith(h, [x, s]),
          d) &&
  ...
  var M,
    ...
    fn =
      ...
      (m.createHTMLDocument =
        ...
        (((M = h.implementation.createHTMLDocument('')).body.innerHTML =
          '<form></form><form></form>'),
  ...
  (T.fn.load = function (e, t, n) {
    ...
    (T.offset = {
      setOffset: function (e, t, n) {
        ...
        'static' === s && (e.style.position = 'relative'),
          ...
          null !=
            (t = T.isFunction(t) ? t.call(e, n, T.extend({}, o)) : t).top &&
            (u.top = t.top - o.top + i),
        ...
        if (this[0])
          return (
            ...
            'fixed' === T.css(r, 'position')
              ...
              : ((e = this.offsetParent()),
                (t = this.offset()),
                ((n = T.nodeName(e[0], 'html') ? n : e.offset()).top +=
                  T.css(e[0], 'borderTopWidth', !0) - e.scrollTop()),
                (n.left +=
                  T.css(e[0], 'borderLeftWidth', !0) - e.scrollLeft())),
            {
    ...
    T.each(['top', 'left'], function (e, n) {
      T.cssHooks[n] = dt(m.pixelPosition, function (e, t) {
        return t
          ? ((t = f(e, n)), lt.test(t) ? T(e).position()[n] + 'px' : t)
          : void 0;
      });
    }),
  ...
  return (
    (T.noConflict = function (e) {
      return w.$ === T && (w.$ = mn), e && w.jQuery === T && (w.jQuery = gn), T;
    }),
    $ || (w.jQuery = w.$ = T),
    T
  );
  ...
  (function (h) {
    ...
    h.fn.split = function (e) {
      ...
      return (
        ...
        (this.settings = l),
        (p = this.children()),
        'vertical' == l.orientation
          ? ((a = p.first().addClass('left_panel')),
            (s = a.next().addClass('right_panel')),
            (t = 'vsplitter'))
          : 'horizontal' == l.orientation &&
            ((a = p.first().addClass('top_panel')),
            (s = a.next().addClass('bottom_panel')),
            (t = 'hsplitter')),
        l.invisible && (t += ' splitter-invisible'),
        (n = this.width()),
        (r = this.height()),
        (i = g++),
        ...
        (d = h.extend(this, {
          refresh: function () {
            var e = this.width(),
              t = this.height();
            (n == e && r == t) ||
              ((n = this.width()), (r = this.height()), d.position(c));
          },
          option: function (e, t) {
            return 'position' === e
              ? d.position(t)
          ...
          position:
            'vertical' == l.orientation
              ? function (e, t) {
                  ...
                  return (
                    l.invisible
                      ? ((r = a.width(c).outerWidth()),
                        s.width(o - r),
                        u.css('left', r - i))
                      : l.percent
                      ? ((n = ((c - i) / o) * 100),
                        (r = a.css('width', n + '%').outerWidth()),
                        s.css('width', ((o - r - e) / o) * 100 + '%'),
                        u.css('left', (r / o) * 100 + '%'))
                      : ((r = a.css('width', c - i).outerWidth()),
                        s.width(o - r - e),
                        u.css('left', r)),
                    a.find('.splitter_panel').eq(0).height(d.height()),
                    s.find('.splitter_panel').eq(0).height(d.height()),
                    t ||
                      (d.trigger('splitter.resize'),
                      d.find('.splitter_panel').trigger('splitter.resize')),
                    d
                  );
                }
              : 'horizontal' == l.orientation
              ? function (e, t) {
                  ...
                  return (
                    l.invisible
                      ? ((r = a.height(c).outerHeight()),
                        s.height(o - r),
                        u.css('top', r - i))
                      : l.percent
                      ? ((n = ((c - i) / o) * 100),
                        (r = a.css('height', n + '%').outerHeight()),
                        s.css('height', ((o - r - e) / o) * 100 + '%'),
                        u.css('top', (r / o) * 100 + '%'))
                      : ((r = a.height(c - i).outerHeight()),
                        s.height(o - r - e),
                        u.css('top', r)),
                    t ||
                      (d.trigger('splitter.resize'),
          ...
          limit:
            ...
            !isNaN(parseFloat(e)) && isFinite(e)
              ? { leftUpper: e, rightBottom: e }
              : e),
          isActive: function () {
            return m === i;
          },
          destroy: function () {
            d.removeClass('splitter_panel'),
              u.unbind('mouseenter'),
              u.unbind('mouseleave'),
              u.unbind('touchstart'),
              u.unbind('touchmove'),
              u.unbind('touchend'),
              u.unbind('touchleave'),
              u.unbind('touchcancel'),
              'vertical' == l.orientation
                ? (a.removeClass('left_panel'), s.removeClass('right_panel'))
                : 'horizontal' == l.orientation &&
                  (a.removeClass('top_panel'), s.removeClass('bottom_panel')),
              d.unbind('splitter.resize'),
              d.trigger('splitter.resize'),
              d.find('.splitter_panel').trigger('splitter.resize'),
              (v[i] = null),
              g--,
              u.remove(),
              d.removeData('splitter');
            for (var e = !1, t = v.length; t--; )
              if (null !== v[t]) {
                e = !0;
                break;
              }
            e ||
              (h(document.documentElement).unbind('.splitter'),
              h(window).unbind('resize.splitter'),
              (v = []),
              (g = 0));
          },
        })).bind('splitter.resize', function (e) {
          var t = d.position();
          'vertical' == d.orientation && t > d.width()
            ? (t = d.width() - d.limit.rightBottom - 1)
            : 'horizontal' == d.orientation &&
              t > d.height() &&
              (t = d.height() - d.limit.rightBottom - 1),
            t < d.limit.leftUpper && (t = d.limit.leftUpper + 1),
            e.stopPropagation(),
            d.position(t, !0);
        }),
        'vertical' == l.orientation
          ? (o =
              o > n - l.limit.rightBottom
                ? n - l.limit.rightBottom
                : f(l.position))
          : 'horizontal' == l.orientation &&
            (o =
              o > r - l.limit.rightBottom
                ? r - l.limit.rightBottom
                : f(l.position)),
        o < l.limit.leftUpper && (o = l.limit.leftUpper),
        d.position(o, !0),
        (p = this.closest('.splitter_panel')).length && this.height(p.height()),
        0 === v.filter(Boolean).length &&
          (h(window).bind('resize.splitter', function () {
            h.each(v, function (e, t) {
              t && t.refresh();
            });
          }),
          h(document.documentElement)
            .on('mousedown.splitter touchstart.splitter', function (e) {
              null !== m &&
                (e.preventDefault(),
                (y = v[m]),
                setTimeout(function () {
                  h('<div class="splitterMask"></div>')
                    .css('cursor', y.children().eq(1).css('cursor'))
                    .insertAfter(y);
                }),
                y.settings.onDragStart(e));
            })
            .bind(
              'mouseup.splitter touchend.splitter touchleave.splitter touchcancel.splitter',
              function (e) {
                y &&
                  (setTimeout(function () {
                    h('.splitterMask').remove();
                  }),
                  y.settings.onDragEnd(e),
                  (y = null));
              }
            )
            .bind('mousemove.splitter touchmove.splitter', function (e) {
              ...
              null !== y &&
                (y.limit.leftUpper,
                (t = y.limit.rightBottom),
                (n = y.offset()),
                'vertical' == y.orientation
                  ? ((r = e.pageX),
                    (r =
                      (r =
                        e.originalEvent && e.originalEvent.changedTouches
                          ? e.originalEvent.changedTouches[0].pageX
                          : r) - n.left) <= y.limit.leftUpper
                      ? (r = y.limit.leftUpper + 1)
                      : r >= y.width() - t && (r = y.width() - t - 1),
                    r > y.limit.leftUpper &&
                      r < y.width() - t &&
                      (y.position(r, !0),
                      y.trigger('splitter.resize'),
                      y.find('.splitter_panel').trigger('splitter.resize')))
                    ...
                    (r =
                      (r =
                        e.originalEvent && e.originalEvent.changedTouches
                          ...
                          : r) - n.top) <= y.limit.leftUpper
                      ? (r = y.limit.leftUpper + 1)
                      : r >= y.height() - t && (r = y.height() - t - 1),
                    r > y.limit.leftUpper) &&
                    r < y.height() - t &&
                    (y.position(r, !0),
                    y.trigger('splitter.resize'),
...
var isDecimal_re = /^\s*(\+|-)?((\d+([,\.]\d+)?)|([,\.]\d+))\s*$/,
  CSVParser = {
    isNumber: function (e) {
      return null != e && !isNaN(new Number(e));
    },
    parse: function (e, t, n, r, i, o, a) {
      var s = [],
        l = new RegExp('[^,]', 'gi'),
        u = e.replace(l, '').length,
        l = new RegExp('[^\t]', 'gi'),
        u = u < e.replace(l, '').length ? '\t' : ',';
      'comma' === n ? (u = ',') : 'tab' === n && (u = '\t'),
        (l = new RegExp('^\n+', 'gi')),
        (e = e.replace(l, '')),
        (l = new RegExp('\n+$', 'gi')),
        (e = e.replace(l, ''));
      for (var c = (s = this.CSVToArray(e, u)).length - 1; 0 <= c; c--)
        for (var d = s[c].length - 1; 0 <= d; d--)
          (s[c][d] = s[c][d].replace('\t', '\\t')),
            (s[c][d] = s[c][d].replace('\n', '\\n')),
            (s[c][d] = s[c][d].replace('\r', '\\r'));
      var p = [],
        f = [],
        h = s[0].length;
      s.length;
      if (t) (p = s.splice(0, 1)[0]), s.length;
      else for (c = 0; c < h; c++) p.push('val' + String(c)), f.push('');
      if (i) for (c = p.length - 1; 0 <= c; c--) p[c] = p[c].toUpperCase();
      if (r) for (c = p.length - 1; 0 <= c; c--) p[c] = p[c].toLowerCase();
      for (c = 0; c < s.length; c++)
        s[c].length != h &&
          this.log(
            'Error parsing row ' + String(c) + '. Wrong number of columns.'
          );
      for (var g = s.length, c = 0; c < p.length; c++) {
        for (var m = 0, v = 0, y = 0; y < g; y++)
          s[y] &&
            (isDecimal_re.test(s[y][c]) &&
              (s[y][c] = s[y][c].replace(',', '.')),
            CSVParser.isNumber(s[y][c])) &&
            (v++, 0 < String(s[y][c]).indexOf('.')) &&
            m++;
        f[c] = 0.9 < v / g ? (0 < m ? 'float' : 'int') : 'string';
      }
      return {
        dataGrid: s,
        headerNames: p,
    ...
    getLog: function () {
      var e = '';
      if (0 < this.errorLog.length) {
        for (var t = 0; t < this.errorLog.length; t++)
          e += '!!' + this.errorLog[t] + '!!\n';
        e += '\n';
      }
      return e;
    ...
    CSVToArray: function (e, t) {
      ...
      for (
        ...
        var o = i[1];
        o.length && o != t && r.push([]),
          (o = i[2] ? i[2].replace(new RegExp('""', 'g'), '"') : i[3]),
          r[r.length - 1].push(o);
      }
      return r;
    },
  ...
  DataGridRenderer = {
        ...
        return (
          e.each(function (e) {
            ...
            if ($(this).find('input').length) {
              var n = $(this).find('input').attr('title');
              r[i] = n;
            } else {
              if (Number(t.length) <= 0) return !0;
              r[i] = t;
            }
            i++;
          }),
          (e = r.join(', ')),
          console.log('joinStr: ' + e),
          String(e)
        );
      });
    },
    html: function (e, t, n, r, i, o) {
      var a = e.length,
        s = t.length,
        l = [],
        u = 0,
      ...
      if ('worklist' != o) {
        for (
          var c =
              (c =
                c +
                ('<div class="' + $('#tableClass').val() + '">' + i) +
                (r + '<table>' + i)) +
              (r + r + '<caption>insert_!@#$|-caption</caption>' + i) +
              (r + r + '<colgroup>' + i),
            d = 0;
          d < s;
          d++
      ...
      if ('col' == o) {
        ...
        for (d = 0; d < a; d++) {
          ...
          c += r + r + r + '<tr>' + i;
          for (p = 0; p < s; p++)
            c += r + r + r + r + '<td>' + f[p] + '</td>' + i;
          c += r + r + r + '</tr>' + i;
        }
      } else if ('row' == o) {
        c = c + (r + r + '<tbody>' + i) + (r + r + r + '<tr>' + i);
        for (p = 0; p < s; p++)
          0 == p
            ? ((c += r + r + r + r + '<th scope="row">' + t[p] + '</th>' + i),
              (l[u++] = t[p]))
            : (c += r + r + r + r + '<td>' + t[p] + '</td>' + i);
        c += r + r + r + '</tr>' + i;
        for (d = 0; d < a; d++) {
          f = e[d];
          c += r + r + r + '<tr>' + i;
          for (p = 0; p < s; p++)
            0 == p
              ? ((c += r + r + r + r + '<th scope="row">' + f[p] + '</th>' + i),
                (l[u++] = f[p]))
              : (c += r + r + r + r + '<td>' + f[p] + '</td>' + i);
          c += r + r + r + '</tr>' + i;
        }
        ...
        c = c + (r + r + '<thead>' + i) + (r + r + r + '<tr>' + i);
        for (p = 0; p < s; p++)
          (c += r + r + r + r + '<th scope="col">' + t[p] + '</th>' + i),
            (l[u++] = t[p]);
        c =
          (c += r + r + r + '</tr>' + i) +
          (r + r + '</thead>' + i) +
      ...
      if ('worklist' == o) {
        var h = worklistHeader;
        c = r + r + '<tbody>' + i + (r + r + r + '<tr>' + i);
        for (p = 0; p < h.length; p++) {
          var g = 'undefined' == String(t[p]) ? '' : t[p];
          'path' == h[p]
            ? (c +=
                r +
                r +
      ...
      return (
        (c = c += r + r + '</tbody>' + i),
        (o = l.join(', ') + ' 항목으로 이루어진 테이블입니다.'),
        (c = (c = c.replace('insert_!@#$|-summary', '')).replace(
          'insert_!@#$|-caption',
          o
        ))
      );
    },
    html_ori: function (e, t, n, r, i) {
      for (
        var o = '',
          a = e.length,
          s = t.length,
          o = (o += '<table>' + i) + (r + '<thead>' + i) + (r + r + '<tr>' + i),
          l = 0;
        l < s;
        l++
      )
        o =
          (o += r + r + r + '<th class="' + t[l] + '-cell">') +
          t[l] +
          '</th>' +
          i;
      o = (o += r + r + '</tr>' + i) + r + '</thead>' + i + r + '<tbody>' + i;
      for (var u = 0; u < a; u++) {
        var c = e[u],
          d = '';
        u === a - 1
          ? (d = ' class="lastRow"')
          : 0 === u && (d = ' class="firstRow"'),
          (o += r + r + '<tr' + d + '>' + i);
        for (l = 0; l < s; l++)
          o =
            (o += r + r + r + '<td class="' + t[l] + '-cell">') +
            c[l] +
            '</td>' +
            i;
        o += r + r + '</tr>' + i;
      }
      return (o = o + (r + '</tbody>' + i) + '</table>');
    },
    json: function (e, t, n, r, i) {
      for (var o = '[', a = e.length, s = t.length, l = 0; l < a; l++) {
        var u = e[l];
        o += '{';
        for (var c, d = 0; d < s; d++)
          (c =
    ...
    jsonArrayCols: function (e, t, n, r, i) {
      var o = '',
        a = e.length,
        s = t.length;
      o += '{' + i;
    ...
    jsonArrayRows: function (e, t, n, r, i) {
      var o = '',
        a = e.length,
        s = t.length;
      o += '[' + i;
    ...
    jsonDict: function (n, e, r, t, i) {
      var o = '',
        a = n.length,
        s = e.length;
      o += '{' + i;
      for (var l = 0; l < a; l++) {
        if (((o += t + '"' + n[l][0] + '": '), 2 == s)) o += c(l, 1);
        else {
          o += '{ ';
          for (var u = 1; u < s; u++)
            1 < u && (o += ', '), (o += '"' + e[u] + '":' + c(l, u));
      ...
      function c(e, t) {
        return 'int' == r[t] || 'float' == r[t]
          ? n[e][t] || 0
          : '"' + (n[e][t] || '') + '"';
      }
      return (o += i + '}');
    },
    xml: function (e, t, n, r, i) {
      var o = '',
        a = e.length,
        s = t.length,
...
function DataConverter(e) {
  (this.nodeId = e),
    ...
    (this.useUnderscores = !0),
    (this.headersProvided = !0),
    (this.downcaseHeaders = !0),
    (this.upcaseHeaders = !1),
    (this.includeWhiteSpace = !0),
    (this.useTabsForIndent = !1);
}
(DataConverter.prototype.create = function (e, t) {
  for (
    var n = this,
      r =
        ((this.inputHeader = $(
          '<div class="groupHeader" id="inputHeader">\t\t<p class="groupHeadline">Input \t\t\t<span class="subhead">\t\t\t\t<a href="#" id="insertSample"> sample</a>\t\t\t</span>\t\t</p></div>'
        )),
        (this.inputTextArea = $(
          '<textarea class="textInputs" id="dataInput"></textarea>'
        )),
        '<div class="groupHeader" id="inputHeader"><p class="groupHeadline">Output<select name="Data Types" id="dataSelector">'),
      i = 0;
    i < this.outputDataTypes.length;
    i++
  )
    r +=
      '<option value="' +
      this.outputDataTypes[i].id +
      '" ' +
      (this.outputDataTypes[i].id == this.outputDataType
        ? 'selected="selected"'
        : '') +
      '>' +
      this.outputDataTypes[i].text +
      '</option>';
  (r += '</select><span class="subhead" id="outputNotes"></span></p></div>'),
    (this.outputHeader = $(r)),
    (this.outputTextArea = $(
  ...
  this.node.append('<div class="wrap inWrap"></div>'),
    ...
    this.node
      .find('.splitWrap')
      .append(
        '<div class="wrap htmlWrap"><div class="groupHeader"><p class="groupHeadline">View </p><div class="textInputs"></div></div></div>'
      ),
    ...
    this.outputTextArea.click(function (e) {
      this.select();
    }),
    $('#insertSample').bind('click', function (e) {
      e.preventDefault(),
        n.insertSampleData(),
        n.convert(),
    ...
    $('#dataInput').change(function () {
      n.convert(), _gaq.push(['_trackEvent', 'DataType', n.outputDataType]);
    }),
    $('#dataSelector').bind('change', function (e) {
      (n.outputDataType = $(this).val()), n.convert();
    });
}),
  (DataConverter.prototype.resize = function (e, t) {
    t = (t - 90) / 2 - 20;
    this.node.css({ width: e }),
      this.inputTextArea.css({ width: e - 20, height: t }),
      this.outputTextArea.css({ width: e - 20, height: t });
  }),
  (DataConverter.prototype.convert = function () {
    var e, t, n, r;
    (this.inputText = this.inputTextArea.val()),
      (this.outputText = ''),
      0 < this.inputText.length &&
        ...
        (e = (r = CSVParser.parse(
          this.inputText,
          this.headersProvided,
          this.delimiter,
          this.downcaseHeaders,
          this.upcaseHeaders,
          this.tableStyle
        )).dataGrid),
        (t = r.headerNames),
        (n = r.headerTypes),
        (r = r.errors),
        (this.outputText = DataGridRenderer[this.outputDataType](
          e,
          t,
          n,
          this.indent,
        ...
        this.outputTextArea.val(r + this.outputText),
        $('.htmlWrap .textInputs').html(this.outputText));
  }),
...
$(document).ready(function () {
  var t = new DataConverter('converter');
  function e(e) {
    e && _gaq.push(['_trackEvent', 'Settings', e.currentTarget.id]),
      (t.includeWhiteSpace = $('#includeWhiteSpaceCB').attr('checked')),
      t.includeWhiteSpace
        ? ($('input[name=indentType]').removeAttr('disabled'),
          'tabs' === (e = $('input[name=indentType]:checked').val())
            ? (t.indent = '\t')
            : 'spaces' === e && (t.indent = '  '))
        : $('input[name=indentType]').attr('disabled', 'disabled'),
      (t.headersProvided = $('#headersProvidedCB').attr('checked')),
      t.headersProvided
        ? ($('input[name=headerModifications]').removeAttr('disabled'),
          'downcase' ===
          (e = $('input[name=headerModifications]:checked').val())
            ? ((t.downcaseHeaders = !0), (t.upcaseHeaders = !1))
            : 'upcase' === e
            ? ((t.downcaseHeaders = !1), (t.upcaseHeaders = !0))
            : 'none' === e &&
              ((t.downcaseHeaders = !1), (t.upcaseHeaders = !1)))
        : $('input[name=headerModifications]').attr('disabled', 'disabled'),
      (t.delimiter = $('input[name=delimiter]:checked').val()),
      (t.decimal = $('input[name=decimal]:checked').val()),
      (t.tableStyle = $('input[name=tableStyle]:checked').val()),
      (t.useUnderscores = !0),
      t.convert();
  }
  t.create(345, 500),
    $('.settingsElement').change(e),
    $(window).bind('resize', function () {}),
    e();
}),
  $(document).ready(function () {
    $('#converter')
      .css({ width: '100%', height: 'calc(100vh - 10px)' })
      .split({ orientation: 'vertical', limit: 100, position: '33.33333%' }),
      $('.splitWrap').split({
